...
export const AMERICAS_BUILDINGS: Building[] = [
{
  ...
  },
  {
    ...
    dossier: {
      en: 'Wright took the commission in June 1943 and spent fifteen years on it, some seven hundred sketches and six sets of working drawings, dying six months before it opened. The idea never changed: one continuous ramp winding up the inside of a drum that widens as it rises, lit from a glazed dome. Visitors were to ride to the top and walk down, so that the pictures arrived as an uninterrupted sequence with the whole void always open beside them. Painters objected before a wall was hung — a curved, sloping, low surface is a hostile place for a rectangle — and twenty-one artists signed a round-robin protest letter arguing the sloped ramp would throw their canvases askew and leave no level baseboard for reference. Wright was unmoved, and the building has outlasted the argument. The ramp is structural as well as circulatory, acting as an arch that braces the outer wall. It became a National Historic Landmark in 2008 and part of a UNESCO World Heritage inscription of eight Wright buildings in 2019.',
      es: 'Wright aceptó el encargo en junio de 1943 y le dedicó quince años, unos setecientos croquis y seis juegos de planos de obra; murió seis meses antes de la inauguración. La idea nunca cambió: una única rampa continua que asciende por dentro de un tambor que se ensancha al subir, iluminado por una cúpula acristalada. El visitante debía subir en ascensor y bajar caminando, de modo que los cuadros llegaran en una secuencia ininterrumpida con el vacío entero siempre abierto a su lado. Los pintores protestaron antes de que se colgara nada —una superficie curva, inclinada y baja es un lugar hostil para un rectángulo— y veintiún artistas firmaron conjuntamente una carta de protesta en la que sostenían que la rampa inclinada torcería sus lienzos y no dejaría un rodapié nivelado como referencia. Wright no se inmutó, y el edificio ha sobrevivido a la polémica. La rampa es tanto estructura como recorrido: funciona como arco que arriostra el muro exterior. Es National Historic Landmark desde 2008 y desde 2019 forma parte de la inscripción en el Patrimonio Mundial de ocho obras de Wright.',
      it: 'Wright accettò l\'incarico nel giugno 1943 e vi dedicò quindici anni, circa settecento schizzi e sei serie di disegni esecutivi; morì sei mesi prima dell\'inaugurazione. L\'idea non cambiò mai: un\'unica rampa continua che sale dentro un tamburo che si allarga salendo, illuminato da una cupola vetrata. Il visitatore doveva salire in ascensore e scendere a piedi, così che i quadri arrivassero in una sequenza ininterrotta con l\'intero vuoto sempre aperto accanto a lui. I pittori protestarono prima ancora che si appendesse qualcosa — una superficie curva, inclinata e bassa è un luogo ostile per un rettangolo — e ventuno artisti firmarono congiuntamente una lettera di protesta sostenendo che la rampa inclinata avrebbe storto le loro tele e non avrebbe lasciato uno zoccolo livellato come riferimento. Wright non si mosse, e l\'edificio è sopravvissuto alla polemica. La rampa è insieme struttura e percorso: lavora come arco che controventa il muro esterno. È National Historic Landmark dal 2008 e dal 2019 fa parte dell\'iscrizione UNESCO di otto opere di Wright.',
    },
    context: null,
    sources: [
      ...
      { kind: 'publication', url: 'https://web.archive.org/web/20071013163633/http://www.time.com/time/magazine/article/0,9171,892851,00.html', title: '"Last Monument" — Time, 2 November 1959 (Wayback Machine archive)', license: null },
    ],
    tier: 'canon',
  },
  {
  ...
  },
  {
    ...
    // detailRect fix round: the old rect ({x:0.06,y:0.38,w:0.30,h:0.26})
    // cropped mostly to tree canopy above the house, with only a narrow
    // strip of steel/glass visible in the lower-left. This one is centred
    // on the brick chimney cylinder (the building's one enclosed, signature
    // volume) sitting on the roofline above the steel-framed glass curtain
    // wall — verified by downloading the primary image and cropping these
    // exact pixels; only a modest strip of tree canopy remains at the very
    // top, well under half the frame.
    detailRect: { x: 0.36, y: 0.485, w: 0.21, h: 0.205 },
    image: {
...

{
    ...
    // detailRect fix round: the old rect ({x:0.30,y:0.02,w:0.35,h:0.30})
    // sat on the sloped roof cladding alone, with no strongly identifying
    // feature. This one is centred lower, on the corner where the
    // cantilevered metal-clad volume overhangs the entrance and the
    // distinctive angled/X-braced steel columns supporting it come into
    // view — verified by downloading the primary image and cropping these
    // exact pixels.
    detailRect: { x: 0.26, y: 0.68, w: 0.32, h: 0.22 },
    image: {
