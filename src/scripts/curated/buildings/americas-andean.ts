...
//
// Two pairs of buildings sit inside the validator's 25 km possible-duplicate-site
// radius purely because they share a city — Edificio Bacardí and the National
// Art Schools are both in Havana, and Basílica de San Francisco and the LUM are
// both in Lima — but they are genuinely distinct sites; see the task report.
export const AMERICAS_ANDEAN_BUILDINGS: Building[] = [
  ...
  },
  {
    ...
    dossier: {
      ...
      es: 'Barclay & Crousse ganó el concurso internacional que el Ministerio de Cultura del Perú abrió en 2008 para un museo que afrontara el conflicto armado interno de 1980-2000, entre el Estado, Sendero Luminoso y el MRTA, que la Comisión de la Verdad y Reconciliación estimó en unas 69.000 víctimas mortales. Sandra Barclay y Jean Pierre Crousse, que habían construido su estudio trabajando el desierto costero peruano como materia prima, situaron el edificio al borde de los acantilados de la Costa Verde en Miraflores, apilando volúmenes de hormigón pigmentado que vuelan hacia el Pacífico y se recorren por dentro mediante rampas y lucernarios en lugar de una planta convencional de escaleras y pasillos. El hormigón áspero, de tono arena, renuncia deliberadamente al ornamento y trata el propio edificio como un contenedor neutro para un guion museográfico que no rehúye nombrar a los responsables de ambos bandos. Terminado en 2015 e inaugurado en diciembre de ese año, el Lugar de la Memoria alberga un centro de documentación, biblioteca y salas permanentes dedicadas a las causas y víctimas del conflicto. Ganó el Hexágono de Oro en la XVI Bienal de Arquitectura del Perú en 2014 y el Premio Oscar Niemeyer en la Bienal Panamericana de Arquitectura de Quito en 2016.',
